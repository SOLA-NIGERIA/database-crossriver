...
SET url = 'http://localhost:8085/geoserver/calabar/wms',
wms_layers= 'calabar:Calabar_20Dec2013_50cm_Colr',
...
UPDATE system.setting SET vl = '426128.5' WHERE "name" = 'map-west'; 
UPDATE system.setting SET vl = '546647.0' WHERE "name" = 'map-south'; 
UPDATE system.setting SET vl = '431206.0' WHERE "name" = 'map-east'; 
UPDATE system.setting SET vl = '551597.0' WHERE "name" = 'map-north'; 
